...
simulationTypes <- c( "Noise_NoN4", "Nonlinearities_NoN4", "NoiseAndNonlinearities_NoN4" )
...
varianceAll$SimulationType <- factor( varianceAll$SimulationType, levels = c( "Noise_NoN4", "Nonlinearities_NoN4", "NoiseAndNonlinearities_NoN4" ) )
...
for( j in seq.int( columnIndices ) )
  ...
  ggsave( filename = paste0( figuresDirectory, "diceVarianceNoN4Study", colnames( varianceAll )[columnIndices[j]], ".pdf" ),
...
simulationTypes <- c( "Noise_NoN4", "NoiseAndNonlinearities_NoN4", "Nonlinearities_NoN4" )
...
for( j in seq.int( length( columnIndices ) ) )
  ...
  ggsave( filename = paste0( figuresDirectory, "diceVarianceStudyNoN4Tukey", colnames( varianceAll )[columnIndices[j]], ".pdf" ),
